...
const TimeSheetApprovals = () => {
  ...
  useEffect(() => {
    setCurrentPage(1);
  }, [projectFilter, userFilter, roleFilter, dateFrom, dateTo, rowsPerPage]);
  ...
  const pageStart = filteredItems.length === 0 ? 0 : (currentPage - 1) * rowsPerPage + 1;
  const pageEnd = Math.min(currentPage * rowsPerPage, filteredItems.length);
  ...
  const toggleSelectAllVisible = (checked) => {
    setSelectedIds((prev) => {
      ...
      const visibleIds = filteredItems.map((item) => String(item.history_id));
      if (checked) {
            ...
            <CardContent>
              ...
              <div className="mt-4 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    <SelectTrigger id="rows-per-page" className="w-[90px]">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
