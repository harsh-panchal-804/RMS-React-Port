...
export function Layout() {
  ...
  const hideTopBar = location.pathname === "/" && isAdminOrManager;
  const isAdminHomeRoute = location.pathname === "/" && isAdminOrManager;
    ...
    >
      <div
        className={cn(
          ...
          isAdminHomeRoute ? "fixed inset-0 h-screen overflow-hidden" : "min-h-screen"
        )}
      >
        <div
          className={cn("absolute left-0 top-0 h-full w-16 z-20", isAdminHomeRoute && "z-50")}
        ...
        <Sidebar 
          ...
          onMouseLeave={() => setHoverOpen(false)}
          className={cn(
            "[&_[data-slot=sidebar-gap]]:!duration-500 [&_[data-slot=sidebar-container]]:!duration-500",
            isAdminHomeRoute && "z-40 [&_[data-slot=sidebar-gap]]:!w-0 [&_[data-slot=sidebar-gap]]:!min-w-0"
          )}
        >
        ...
        <SidebarInset className={cn("flex-1 w-full flex flex-col", isAdminHomeRoute && "h-full overflow-hidden")}>
          {!hideTopBar && (
          ...
          <div className={cn("flex-1", isAdminHomeRoute ? "overflow-hidden" : "overflow-auto")}>
            <Routes>
